        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative z-10">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {bestSellers.map((item) => (
                  <span
                    key={item}
                    className="inline-flex items-center gap-1 bg-amber-50 text-amber-900 px-3 py-1 rounded-full text-sm border border-amber-200"
                  >
            ...
            <div className="flex flex-wrap gap-4">
              <Button
                size="lg"
                className="bg-gradient-to-r from-pickle-700 to-pickle-600 hover:from-pickle-800 hover:to-pickle-700 text-white shadow-lg"
                asChild
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-spice-500 text-spice-600 hover:bg-spice-50"
                asChild
              >
